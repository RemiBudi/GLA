...
public class WebServices {
	...
	public long createPin(Pin pin) {
	   ...
	   Pin newPin = new PinDaoImpl(pmf).createPin(pin.getId(), pin.getUser(), pin.getTitle(), pin.getDescription(), pin.getTags(), pin.getLatitude(), pin.getLongitude());
	...
	public Pin editPin(Pin pin) {
		System.out.println("EDITrtt");
		PinDaoImpl tmp = new PinDaoImpl(pmf);
	    Pin oldPin = tmp.getPin(pin.getId());
	    System.out.println("Pin_id:" + oldPin.getId());
	   
	    tmp.removePin(oldPin.getId());
	    Pin newPin = tmp.createPin(pin.getId(), pin.getUser(), pin.getTitle(), pin.getDescription(), pin.getTags(), pin.getLatitude(), pin.getLongitude());
	   return newPin;
	    } 
