...
public class WebServices {
	...
	public void createUser(String username) {
		User newUser = new UserDaoImpl().createUser(username);
	...
	public void removeUser(@PathParam("username") String username){
		...
		new UserDaoImpl().removeUser(username);
	}
	...
	public User addFriend(@PathParam("username") String username, String friendUsername) {
			User user = new UserDaoImpl().getUser(username);
			new UserDaoImpl().addFriend(user, username);
			return user;
		}
